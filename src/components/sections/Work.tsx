...
const ThumbnailCard = ({
  ...
  const { ref, style } = useScrollReveal({ direction: 'up' });
  return (
    <div
      ref={ref}
      style={style}
...
const ProjectArticle = ({
  ...
  onProjectImageClick: (projectImages: (string | ProjectImage)[], index: number, defaultAlt: string) => void;
  getFirstImageSrc: (images: (string | ProjectImage)[]) => string;
        ...
        >
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              <Button
                variant="secondary"
                onClick={() => onProjectImageClick(project.images, 0, project.title)}
...
export const Work = () => {
  ...
  const { ref: ctaRef, style: ctaStyle } = useScrollReveal({ delay: 200, direction: 'up' });
  ...
  return (
    <section id="work" className="section bg-surface/30" aria-labelledby="work-heading">
      <div className="container">
        ...
        <div className="space-y-20">
          {projects.map((project, projectIndex) => (
            <ProjectArticle
              ...
              onProjectImageClick={handleProjectImageClick}
              getFirstImageSrc={getFirstImageSrc}
        ...
        <div ref={ctaRef} style={ctaStyle} className="text-center mt-16 p-8 rounded-3xl bg-surface/40 border border-border/50 max-w-2xl mx-auto">
